    ...
    <div class="card">
      ...
      <div id="wheels" class="parts">
        ...
        <div class="regions-list">
          <div class="region-item"><strong>${t('japan')}:</strong> <span class="part-item">${tireRegions.japan.join(', ')}</span></div>
          <div class="region-item"><strong>${t('china')}:</strong> <span class="part-item">${tireRegions.china.join(', ')}</span></div>
          <div class="region-item"><strong>${t('korea')}:</strong> <span class="part-item">${tireRegions.korea.join(', ')}</span></div>
          <div class="region-item"><strong>${t('europe')}:</strong> <span class="part-item">${tireRegions.europe.join(', ')}</span></div>
        </div>
      </div>
    </div>
  `;
